...
async function main() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  PCCV - 3W Passengers (Capacity > 6 & NOT > 17) - All Data     ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');

  const productCode = 'MOT-PRD-005';
  const productClass = 'CLASS_4C3';
  const productName = 'PCCV-3 wheeled vehicles-carrying passengers > 6 but NOT >17';
  ...
  const filename = `/Users/apple/js_scrapper/manufacturers_data/manufacturers_with_models_PCCV_3_WHEELERS_PASSENGERS_GREATER_THAN_6_NOT_GREATER_THAN_17_${timestamp}.json`;
  ...
  console.log(`\n💾 Saved to: manufacturers_data/manufacturers_with_models_PCCV_3_WHEELERS_PASSENGERS_GREATER_THAN_6_NOT_GREATER_THAN_17_${timestamp}.json`);
  console.log('\n✨ All done!');
}
