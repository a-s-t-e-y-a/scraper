...
async function main() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  Goods Carrying - Three Wheelers (Private) - Manufacturer & Models  ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');

  const productCode = 'MOT-PRD-003';
  const productClass = 'CLASS_4A4';
  const productName = 'GOODS CARRYING MOTORISED THREE WHEELERS AND MOTORISED PEDAL CYCLES-PRIVATE CARRIERS';
  ...
  const filename = `/Users/apple/js_scrapper/manufacturers_data/manufacturers_with_models_GOODS_CARRYING_MOTORISED_THREE_WHEELERS_PRIVATE_CARRIERS_${timestamp}.json`;
  ...
  console.log(`\n💾 Saved to: manufacturers_data/manufacturers_with_models_GOODS_CARRYING_MOTORISED_THREE_WHEELERS_PRIVATE_CARRIERS_${timestamp}.json`);
  console.log('\n✨ All done!');
}
