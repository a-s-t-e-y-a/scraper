...
async function main() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  PCCV - 3W Passengers (Capacity ≤ 6) - Manufacturer & Models    ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');

  const productCode = 'MOT-PRD-005';
  const productClass = 'CLASS_4C1B';
  const productName = 'PCCV-3 wheelers-carrying passengers-capacity NOT > 6';
  ...
  const filename = `/Users/apple/js_scrapper/manufacturers_data/manufacturers_with_models_PCCV_3_WHEELERS_PASSENGERS_CAPACITY_NOT_GREATER_THAN_6_${timestamp}.json`;
  ...
  console.log(`\n💾 Saved to: manufacturers_data/manufacturers_with_models_PCCV_3_WHEELERS_PASSENGERS_CAPACITY_NOT_GREATER_THAN_6_${timestamp}.json`);
  console.log('\n✨ All done!');
}
