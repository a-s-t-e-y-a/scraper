...
async function fetchAllData() {
  console.log('\n╔════════════════════════════════════════════════════════════════╗');
  console.log('║    FETCH MANUFACTURERS & MODELS (PCCV Types 1-11)              ║');
  ...
  for (let pccvType = 1; pccvType <= 11; pccvType++) {
    console.log(`\n📦 PCCV Type ${pccvType}/11 - Fetching manufacturers...`);
  ...
  const combinedFile = path.join(dataDir, 'pccvTypes_1_11_combined_manufacturers_models_full.json');
  ...
  console.log(`✅ Combined file created: pccvTypes_1_11_combined_manufacturers_models_full.json`);
  console.log(`\n📊 SUMMARY:`);
  console.log(`   Total PCCV Types: 11`);
  console.log(`   Total Manufacturers: ${totalManufacturers}`);
  console.log(`   Total Models: ${totalModels}`);
  console.log(`\n📁 File location: data/pccvTypes_1_11_combined_manufacturers_models_full.json`);
  console.log('\n✨ Done!\n');
}
