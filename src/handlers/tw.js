/**
 * Two Wheeler Handler
 * Extends BaseHandler with TW-specific logic
 */
...
class TwoWheelerHandler extends BaseHandler {
    constructor() {
        ...
        this.selectors = {
            ...
            tabDisplayText: 'Two Wheeler',
            vehicleTypeSelector: '#vehicleType',
            vehicleTypeOption: 'TWO WHEELER',
    ...
    /**
     * Two Wheeler specific scraping logic
     */
    ...
    /**
     * Scrape all models across all pages with pagination
     */
...
module.exports = new TwoWheelerHandler();
