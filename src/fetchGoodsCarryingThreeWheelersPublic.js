...
const CURRENT_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..SMtzcHVuz_hcLpA_o4JABUAHE6K8fvNwDpkLRa4G9CM";
...
async function main() {
  console.log('╔══════════════════════════════════════════════════════════════╗');
  console.log('║  Goods Carrying - Three Wheelers (Public) - Manufacturer & Models   ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');

  const productCode = 'MOT-PRD-003';
  const productClass = 'CLASS_4A3';
  const productName = 'GOODS CARRYING MOTORISED THREE WHEELERS AND MOTORISED PEDAL CYCLES-PUBLIC CARRIERS';
  ...
  const manufacturerResult = await fetchManufacturers(token, productCode, productClass, 0, 2000);
  ...
  const filename = `/Users/apple/js_scrapper/manufacturers_data/manufacturers_with_models_GOODS_CARRYING_MOTORISED_THREE_WHEELERS_PUBLIC_CARRIERS_${timestamp}.json`;
  ...
  console.log(`\n💾 Saved to: manufacturers_data/manufacturers_with_models_GOODS_CARRYING_MOTORISED_THREE_WHEELERS_PUBLIC_CARRIERS_${timestamp}.json`);
  console.log('\n✨ All done!');
}
