...
async function main() {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║  GCCV - Private Carriers (Others) - Manufacturer & Models   ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');

  const productCode = 'MOT-PRD-003';
  const productClass = 'CLASS_4A2';
  const productName = 'GCCV-PRIVATE CARRIERS OTHER THAN THREE WHEELERS';
  ...
  const filename = `/Users/apple/js_scrapper/manufacturers_data/manufacturers_with_models_GCCV_PRIVATE_CARRIERS_OTHER_THAN_THREE_WHEELERS_${timestamp}.json`;
  ...
  console.log(`\n💾 Saved to: manufacturers_data/manufacturers_with_models_GCCV_PRIVATE_CARRIERS_OTHER_THAN_THREE_WHEELERS_${timestamp}.json`);
  console.log('\n✨ All done!');
}
